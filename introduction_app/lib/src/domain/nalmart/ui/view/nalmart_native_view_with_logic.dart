...
class NalmartNativeViewWithLogic extends StatelessWidget {
  const NalmartNativeViewWithLogic({
          ...
          children: [
            ...
            SizedBox(
              ...
              child: BlocBuilder<NativeBloc, NativeState>(
                buildWhen: (NativeState previous, NativeState current) => previous.adCards != current.adCards,
            ...
            BlocBuilder<NativeBloc, NativeState>(
              buildWhen: (NativeState previous, NativeState current) => previous.deliveryStatus != current.deliveryStatus,
              builder: (BuildContext context, NativeState state) {
                return DeliveryInfo(
